...
export function drawParticle(container, context, particle, delta, fillColorValue, strokeColorValue, backgroundMask, composite, radius, opacity, shadow, gradient) {
    ...
    if (tiltOptions.enable || rollOptions.enable) {
        ...
        const rollHorizontal = roll && (rollOptions.mode === "horizontal" /* horizontal */ || rollOptions.mode === "both" /* both */);
        const rollVertical = roll && (rollOptions.mode === "vertical" /* vertical */ || rollOptions.mode === "both" /* both */);
    ...
    if (gradient) {
        ...
        const fillGradient = gradient.type === "radial" /* radial */
